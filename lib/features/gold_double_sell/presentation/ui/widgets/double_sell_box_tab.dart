...
class DoubleSellBoxTab extends StatefulWidget {
  ...
  @override
  State<DoubleSellBoxTab> createState() => _DoubleSellBoxTabState();
}

class _DoubleSellBoxTabState extends State<DoubleSellBoxTab> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: DropdownButtonFormField<GoldBoxModel>(
                  isExpanded: true,
                  value: _selectedBox,
  ...
  void _addItem() {
    ...
    final price = DoubleSellPriceCalculator.boxPrice(
      grams: grams,
      loss: loss,
      gramPrice: gramPrice,
      mc: mc,
