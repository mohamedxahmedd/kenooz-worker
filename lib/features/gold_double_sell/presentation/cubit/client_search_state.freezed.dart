...
part of 'client_search_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClientSearchState);
}
...
/// @nodoc
class $ClientSearchStateCopyWith<$Res>  {
$ClientSearchStateCopyWith(ClientSearchState _, $Res Function(ClientSearchState) __);
}


/// Adds pattern-matching-related methods to [ClientSearchState].
extension ClientSearchStatePatterns on ClientSearchState {
...
class _Initial implements ClientSearchState {
  const _Initial();
...
class Loading implements ClientSearchState {
  const Loading();
...
@override
String toString() {
  return 'ClientSearchState.loading()';
}
...
class Found implements ClientSearchState {
  const Found(this.client);
  

 final  ClientModel client;

/// Create a copy of ClientSearchState
...
@override
String toString() {
  return 'ClientSearchState.found(client: $client)';
}
...
/// @nodoc
abstract mixin class $FoundCopyWith<$Res> implements $ClientSearchStateCopyWith<$Res> {
...
class NotFound implements ClientSearchState {
  const NotFound();
...
@override
String toString() {
  return 'ClientSearchState.notFound()';
}
...
class Created implements ClientSearchState {
...
@override
String toString() {
  return 'ClientSearchState.created(client: $client)';
}
...
/// @nodoc
abstract mixin class $CreatedCopyWith<$Res> implements $ClientSearchStateCopyWith<$Res> {
...
class Error implements ClientSearchState {
...
@override
String toString() {
  return 'ClientSearchState.error(messages: $messages)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $ClientSearchStateCopyWith<$Res> {
