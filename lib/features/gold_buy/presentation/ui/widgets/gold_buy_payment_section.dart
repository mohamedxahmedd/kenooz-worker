...
class GoldBuyPaymentSection extends StatefulWidget {
  final double totalBuyPrice;
  final List<PaymentAccountModel> accounts;
  final List<GoldBuyPaymentEntry> entries;
  final ValueChanged<GoldBuyPaymentEntry> onAdd;
  final ValueChanged<int> onRemove;

  const GoldBuyPaymentSection({
    super.key,
  ...
  @override
  State<GoldBuyPaymentSection> createState() => _GoldBuyPaymentSectionState();
}

class _GoldBuyPaymentSectionState extends State<GoldBuyPaymentSection> {
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark
              ...
              : AppColors.goldColor.withOpacity(0.14),
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 4.h),
          Text(
            '${'gold_buy.rest'.tr()}: ${_restOfCartTotal.toStringAsFixed(2)} ${'common.egp'.tr()}',
            style: AppFonts.body(
              fontSize: 12.sp,
              fontWeight: FontWeight.w600,
              color: isDark
