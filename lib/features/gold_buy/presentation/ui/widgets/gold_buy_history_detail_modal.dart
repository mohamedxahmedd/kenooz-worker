...
class GoldBuyHistoryDetailModal extends StatelessWidget {
  final GoldBuyFullHistoryModel buy;
  const GoldBuyHistoryDetailModal({super.key, required this.buy});

  static void show(BuildContext context, GoldBuyFullHistoryModel buy) {
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (_) => GoldBuyHistoryDetailModal(buy: buy),
    );
  }
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: SvgPicture.asset('assets/images/gold-buy.svg'),
                  ),
                  SizedBox(width: 12.w),
                  Expanded(
                    child: Column(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.link_rounded,
                            size: 13.sp, color: AppColors.goldColor),
                        SizedBox(width: 4.w),
                        Text(
                          '${'gold_buy.sellRecord'.tr()} #${buy.sellId}',
                          style: AppFonts.body(
                            fontSize: 11.sp,
