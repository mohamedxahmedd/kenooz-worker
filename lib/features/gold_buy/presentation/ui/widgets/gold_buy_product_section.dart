...
import 'package:kenooz_worker_app/features/gold_buy/presentation/ui/widgets/gold_buy_product_card.dart';
import 'package:kenooz_worker_app/features/gold_buy/presentation/ui/widgets/gold_buy_product_form_sheet.dart';
...
class GoldBuyProductSection extends StatelessWidget {
  ...
  void _openProductForm(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => GoldBuyProductFormSheet(
        carats: carats,
        boxes: boxes,
        onCreateCarat: () {
