...
class GoldBuyCreateClientSheet extends StatefulWidget {
  const GoldBuyCreateClientSheet({super.key});

  @override
  State<GoldBuyCreateClientSheet> createState() =>
      _GoldBuyCreateClientSheetState();
}

class _GoldBuyCreateClientSheetState extends State<GoldBuyCreateClientSheet> {
