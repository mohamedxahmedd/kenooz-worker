...
part of 'diamond_client_search_state.dart';
...
/// @nodoc
mixin _$DiamondClientSearchState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DiamondClientSearchState);
}
...
@override
String toString() {
  return 'DiamondClientSearchState()';
}
...
/// @nodoc
class $DiamondClientSearchStateCopyWith<$Res>  {
$DiamondClientSearchStateCopyWith(DiamondClientSearchState _, $Res Function(DiamondClientSearchState) __);
}


/// Adds pattern-matching-related methods to [DiamondClientSearchState].
extension DiamondClientSearchStatePatterns on DiamondClientSearchState {
...
class _Initial implements DiamondClientSearchState {
  const _Initial();
...
@override
String toString() {
  return 'DiamondClientSearchState.initial()';
}
...
class Loading implements DiamondClientSearchState {
  const Loading();
...
@override
String toString() {
  return 'DiamondClientSearchState.loading()';
}
...
class Found implements DiamondClientSearchState {
  const Found(this.client);
  

 final  ClientModel client;

/// Create a copy of DiamondClientSearchState
...
@override
String toString() {
  return 'DiamondClientSearchState.found(client: $client)';
}
...
/// @nodoc
abstract mixin class $FoundCopyWith<$Res> implements $DiamondClientSearchStateCopyWith<$Res> {
...
class NotFound implements DiamondClientSearchState {
  const NotFound();
...
@override
String toString() {
  return 'DiamondClientSearchState.notFound()';
}
...
class Created implements DiamondClientSearchState {
...
@override
String toString() {
  return 'DiamondClientSearchState.created(client: $client)';
}
...
/// @nodoc
abstract mixin class $CreatedCopyWith<$Res> implements $DiamondClientSearchStateCopyWith<$Res> {
...
class Error implements DiamondClientSearchState {
...
@override
String toString() {
  return 'DiamondClientSearchState.error(messages: $messages)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $DiamondClientSearchStateCopyWith<$Res> {
