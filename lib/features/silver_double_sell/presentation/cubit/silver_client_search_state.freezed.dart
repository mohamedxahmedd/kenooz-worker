...
part of 'silver_client_search_state.dart';
...
/// @nodoc
mixin _$SilverClientSearchState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SilverClientSearchState);
}
...
@override
String toString() {
  return 'SilverClientSearchState()';
}
...
/// @nodoc
class $SilverClientSearchStateCopyWith<$Res>  {
$SilverClientSearchStateCopyWith(SilverClientSearchState _, $Res Function(SilverClientSearchState) __);
}


/// Adds pattern-matching-related methods to [SilverClientSearchState].
extension SilverClientSearchStatePatterns on SilverClientSearchState {
...
class _Initial implements SilverClientSearchState {
  const _Initial();
...
@override
String toString() {
  return 'SilverClientSearchState.initial()';
}
...
class Loading implements SilverClientSearchState {
  const Loading();
...
@override
String toString() {
  return 'SilverClientSearchState.loading()';
}
...
class Found implements SilverClientSearchState {
  const Found(this.client);
  

 final  ClientModel client;

/// Create a copy of SilverClientSearchState
...
@override
String toString() {
  return 'SilverClientSearchState.found(client: $client)';
}
...
/// @nodoc
abstract mixin class $FoundCopyWith<$Res> implements $SilverClientSearchStateCopyWith<$Res> {
...
class NotFound implements SilverClientSearchState {
  const NotFound();
...
@override
String toString() {
  return 'SilverClientSearchState.notFound()';
}
...
class Created implements SilverClientSearchState {
...
@override
String toString() {
  return 'SilverClientSearchState.created(client: $client)';
}
...
/// @nodoc
abstract mixin class $CreatedCopyWith<$Res> implements $SilverClientSearchStateCopyWith<$Res> {
...
class Error implements SilverClientSearchState {
...
@override
String toString() {
  return 'SilverClientSearchState.error(messages: $messages)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $SilverClientSearchStateCopyWith<$Res> {
