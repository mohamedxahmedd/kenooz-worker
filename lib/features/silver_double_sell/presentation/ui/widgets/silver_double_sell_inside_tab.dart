...
import 'package:kenooz_worker_app/features/silver_double_sell/presentation/ui/widgets/silver_double_sell_product_card.dart';

class SilverDoubleSellInsideTab extends StatefulWidget {
  final SilverProductLookupState lookupState;
  final TextEditingController productIdController;
  final VoidCallback onLookup;
  final VoidCallback onClearLookup;
  final ValueChanged<DoubleSellCartItemModel> onAddItem;

  const SilverDoubleSellInsideTab({
    super.key,
  ...
  @override
  State<SilverDoubleSellInsideTab> createState() =>
      _SilverDoubleSellInsideTabState();
}

class _SilverDoubleSellInsideTabState extends State<SilverDoubleSellInsideTab> {
    ...
    return Column(
      ...
      children: [
        ...
        widget.lookupState.maybeWhen(
          ...
          found: (product) {
            final price = SilverDoubleSellPriceCalculator.insidePrice(
              mc: product.mc,
            ...
            return SilverDoubleSellProductCard(product: product, price: price);
          },
          orElse: () => _message(
            'silver_double_sell.scanOrEnterProductId'.tr(),
