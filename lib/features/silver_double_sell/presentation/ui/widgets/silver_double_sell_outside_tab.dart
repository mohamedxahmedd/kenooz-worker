...
class SilverDoubleSellOutsideTab extends StatefulWidget {
  ...
  const SilverDoubleSellOutsideTab({
    super.key,
  ...
  @override
  State<SilverDoubleSellOutsideTab> createState() => _SilverDoubleSellOutsideTabState();
}

class _SilverDoubleSellOutsideTabState extends State<SilverDoubleSellOutsideTab> {
  ...
  void _addItem() {
    ...
    final price = SilverDoubleSellPriceCalculator.outsidePrice(
      grams: grams,
      gramPrice: gramPrice,
      mc: mc,
      profit: profit,
    ...
    widget.onAddItem(
      DoubleSellCartItemModel(
        ...
        subtitle: 'silver_double_sell.outside'.tr(),
        grams: grams,
        price: price,
        payload: {
          'carat_id': carat.id,
