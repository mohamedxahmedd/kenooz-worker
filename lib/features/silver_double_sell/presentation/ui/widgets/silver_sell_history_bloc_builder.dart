...
import 'package:kenooz_worker_app/features/silver_double_sell/presentation/ui/widgets/silver_sell_history_card.dart';
import 'package:kenooz_worker_app/features/silver_double_sell/presentation/ui/widgets/silver_sell_history_detail_modal.dart';
import 'package:kenooz_worker_app/features/silver_double_sell/presentation/ui/widgets/silver_sell_history_shimmer.dart';

class SilverSellHistoryBlocBuilder extends StatelessWidget {
  final VoidCallback onRetry;
  final VoidCallback onAddNew;

  const SilverSellHistoryBlocBuilder({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SilverSellHistoryCubit, SilverSellHistoryState>(
      builder: (context, state) => switch (state) {
        SilverSellHistoryInitial() ||
        SilverSellHistoryLoading() =>
          const SilverSellHistoryShimmer(),
        SilverSellHistorySuccess(:final sells) =>
          _SuccessView(sells: sells, onAddNew: onAddNew),
        SilverSellHistoryError(:final message) =>
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8.h),
              Text(
                'silver_double_sell.tapButtonToCreate'.tr(),
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) => GestureDetector(
        onTap: () => SilverSellHistoryDetailModal.show(context, sells[index]),
        child: SilverSellHistoryCard(sell: sells[index]),
      ),
    );
  }
}
