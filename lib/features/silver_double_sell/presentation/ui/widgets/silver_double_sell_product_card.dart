...
class SilverDoubleSellProductCard extends StatelessWidget {
  final SilverProductModel product;
  final double price;

  const SilverDoubleSellProductCard({
    super.key,
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark
              ...
              : const Color(0xFF9E9E9E).withOpacity(0.24),
        ),
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                Text(
                  'Carat: ${product.caratName.isEmpty ? product.caratId.toString() : product.caratName}',
                  style: AppFonts.body(
                    fontSize: 12.sp,
  ...
  Widget _placeholder() {
    return Container(
      ...
      child: Icon(Icons.inventory_2_rounded, size: 28.sp, color: AppColors.darkBrown),
    );
  }
}
