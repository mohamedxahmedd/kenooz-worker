class SilverBuyItemHistoryModel {
  final int id;
  final double grams;
  final double loss;
  ...
  factory SilverBuyItemHistoryModel.fromJson(Map<String, dynamic> json) {
    final carat = json['carat'] as Map<String, dynamic>? ?? {};
    final box = json['box'] as Map<String, dynamic>?;
    return SilverBuyItemHistoryModel(
