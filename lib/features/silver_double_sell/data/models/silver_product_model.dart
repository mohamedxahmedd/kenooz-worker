...
part 'silver_product_model.g.dart';

@JsonSerializable(createFactory: false)
class SilverProductModel {
  final int id;
  final int shopId;
  final int kindId;
  final int caratId;
  ...
  factory SilverProductModel.fromJson(Map<String, dynamic> json) {
    final mediaList = json['media'] as List<dynamic>? ?? const [];

    return SilverProductModel(
  ...
  Map<String, dynamic> toJson() => _$SilverProductModelToJson(this);
}
