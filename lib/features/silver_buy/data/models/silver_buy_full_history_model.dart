...
class SilverBuyFullHistoryModel {
  final int id;
  final double total;
  final String? notes;
  final int? sellId;
  ...
  factory SilverBuyFullHistoryModel.fromJson(Map<String, dynamic> json) {
    ...
    return SilverBuyFullHistoryModel(
      ...
      items: rawItems
          .map(
            (e) => SilverBuyItemHistoryModel.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
  }
