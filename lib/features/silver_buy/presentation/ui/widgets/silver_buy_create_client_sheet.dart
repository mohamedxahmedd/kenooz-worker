...
class SilverBuyCreateClientSheet extends StatefulWidget {
  const SilverBuyCreateClientSheet({super.key});

  @override
  State<SilverBuyCreateClientSheet> createState() =>
      _SilverBuyCreateClientSheetState();
}

class _SilverBuyCreateClientSheetState
    extends State<SilverBuyCreateClientSheet> {
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem(
                  value: 'male',
                  child: Text('common.male'.tr()),
                ),
                DropdownMenuItem(
                  value: 'female',
                  child: Text('common.female'.tr()),
                ),
              ],
              onChanged: (value) {
