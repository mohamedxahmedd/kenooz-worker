...
class SilverBuyCreateCaratSheet extends StatefulWidget {
  const SilverBuyCreateCaratSheet({super.key});

  @override
  State<SilverBuyCreateCaratSheet> createState() =>
      _SilverBuyCreateCaratSheetState();
}

class _SilverBuyCreateCaratSheetState extends State<SilverBuyCreateCaratSheet> {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            CustomButton(
              text: 'silver_buy.createCarat'.tr(),
              onPressed: _submit,
  ...
  void _submit() {
    ...
    Navigator.of(context).pop(
      CreateSilverCaratRequestModel(carat: carat, fixed: fixed, price: price),
    );
  }
}
