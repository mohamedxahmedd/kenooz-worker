...
class SilverBuySummaryWidget extends StatelessWidget {
  final double totalBuyPrice;
  final double totalPaid;

  const SilverBuySummaryWidget({
    super.key,
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark
              ...
              : AppColors.silverColor.withOpacity(0.15),
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          _line(
            context,
            'silver_buy.totalBuyPrice'.tr(),
            totalBuyPrice,
            isDark: isDark,
          ),
          _line(
            context,
            'silver_buy.totalPaid'.tr(),
            totalPaid,
            isDark: isDark,
          ),
          SizedBox(height: 8.h),
  ...
  Widget _line(
    ...
    Color valueColor = AppColors.silverColor;
    if (emphasize) {
