...
class SilverBuySourceSection extends StatefulWidget {
  ...
  @override
  State<SilverBuySourceSection> createState() => _SilverBuySourceSectionState();
}

class _SilverBuySourceSectionState extends State<SilverBuySourceSection> {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: isDark
                            ? [
                                AppColors.silverColor.withOpacity(0.95),
                                AppColors.silverColor.withOpacity(0.85),
                              ]
                            : [AppColors.silverColor, AppColors.silverColor],
                      ),
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: AppColors.silverColor.withOpacity(0.24),
                          blurRadius: 10,
