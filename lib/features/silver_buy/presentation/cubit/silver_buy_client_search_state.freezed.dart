...
part of 'silver_buy_client_search_state.dart';
...
/// @nodoc
mixin _$SilverBuyClientSearchState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SilverBuyClientSearchState);
}
...
@override
String toString() {
  return 'SilverBuyClientSearchState()';
}
...
/// @nodoc
class $SilverBuyClientSearchStateCopyWith<$Res>  {
$SilverBuyClientSearchStateCopyWith(SilverBuyClientSearchState _, $Res Function(SilverBuyClientSearchState) __);
}


/// Adds pattern-matching-related methods to [SilverBuyClientSearchState].
extension SilverBuyClientSearchStatePatterns on SilverBuyClientSearchState {
...
class _Initial implements SilverBuyClientSearchState {
  const _Initial();
...
@override
String toString() {
  return 'SilverBuyClientSearchState.initial()';
}
...
class Loading implements SilverBuyClientSearchState {
  const Loading();
...
@override
String toString() {
  return 'SilverBuyClientSearchState.loading()';
}
...
class Found implements SilverBuyClientSearchState {
  const Found(this.client);
  

 final  ClientModel client;

/// Create a copy of SilverBuyClientSearchState
...
@override
String toString() {
  return 'SilverBuyClientSearchState.found(client: $client)';
}
...
/// @nodoc
abstract mixin class $FoundCopyWith<$Res> implements $SilverBuyClientSearchStateCopyWith<$Res> {
...
class NotFound implements SilverBuyClientSearchState {
  const NotFound();
...
@override
String toString() {
  return 'SilverBuyClientSearchState.notFound()';
}
...
class Created implements SilverBuyClientSearchState {
...
@override
String toString() {
  return 'SilverBuyClientSearchState.created(client: $client)';
}
...
/// @nodoc
abstract mixin class $CreatedCopyWith<$Res> implements $SilverBuyClientSearchStateCopyWith<$Res> {
...
class Error implements SilverBuyClientSearchState {
...
@override
String toString() {
  return 'SilverBuyClientSearchState.error(messages: $messages)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $SilverBuyClientSearchStateCopyWith<$Res> {
